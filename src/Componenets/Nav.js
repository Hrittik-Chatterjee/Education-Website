                ...
                <div className='relative flex items-center justify-between'>
                    ...
                    >
                        <div className='flex'>
                            ...
                            <h1 className='mt-4 ml-4 text-black'> Dev Edu</h1>
                        </div>
                    </Link>
                    ...
                    {user && user?.uid ?
                        <div className="dropdown dropdown-end">
                            <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
                                <div className="w-10 rounded-full tooltip tooltip-open tooltip-bottom " data-tip={user.name}>
                                    <img data-tip data-for="nameProfile" alt='profile' src={user?.photoURL} />
                                    <ReactTooltip id="nameProfile" place="top" effect="solid">
                                        {user.displayName}
                                    </ReactTooltip>
                                </div>
                            </label>
