...
const Home = () => {
    ...
    return (
        <div  className='h-fit mt-28' >
            ...
            <h1 className='text-4xl sm:text-9xl text-black text-center font-bold'>Welcome to our Website Dev Edu!!!</h1>
            
            <p className='text-black text-center text-sm  sm:text-base font-semibold mt-12'>
            ...
            <div className='flex justify-center mt-10 h- pb-4'>
